...
namespace Offer_Microservice
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient("employee", x =>
            {
                x.BaseAddress = new Uri("https://localhost:44321/");
            });
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Offer_Microservice", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Offer_Microservice v1"));
            }
